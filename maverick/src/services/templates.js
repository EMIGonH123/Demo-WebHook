...
function getTemplateBtnsWhitImg(default_action, btns, titulo = "Titulo", subtitle = "Subtitulo", image_url = "https://webhook-maverick.herokuapp.com/personas/Mavermate.jpg") {
    return {
        "attachment": {
            "type": "template",
            "payload": {
